...
var file_depotpb_messages_proto_rawDesc = []byte{
	...
	0x79, 0x42, 0x85, 0x01, 0x0a, 0x0b, 0x63, 0x6f, 0x6d, 0x2e, 0x64, 0x65, 0x70, 0x6f, 0x74, 0x70,
	0x62, 0x42, 0x0d, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f,
	0x50, 0x01, 0x5a, 0x2b, 0x65, 0x64, 0x61, 0x2d, 0x69, 0x6e, 0x2d, 0x67, 0x6f, 0x6c, 0x61, 0x6e,
	0x67, 0x2f, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x73, 0x2f, 0x64, 0x65, 0x70, 0x6f, 0x74, 0x2f,
...
func file_depotpb_messages_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_depotpb_messages_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_depotpb_messages_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_depotpb_messages_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Stop); i {
			case 0:
				return &v.state
			case 1:
		...
		file_depotpb_messages_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Item); i {
			case 0:
				return &v.state
			case 1:
