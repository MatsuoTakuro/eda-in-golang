...
// Root sets up the ordering module to run as either a standalone microservice or a monolith module.
func Root(ctx context.Context, svc system.Service) (err error) {
	...
	container.AddSingleton("stream", func(c di.Container) (any, error) {
		return jetstream.NewStream("ordering", svc.Config().Nats.Stream, svc.JS(), c.Get("logger").(zerolog.Logger)), nil
	})
