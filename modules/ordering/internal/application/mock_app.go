...
import (
	...
	domain "eda-in-golang/modules/ordering/internal/domain"

	mock "github.com/stretchr/testify/mock"

	queries "eda-in-golang/modules/ordering/internal/application/queries"
)
...
func (_m *MockApp) CreateOrder(ctx context.Context, cmd commands.CreateOrder) (string, bool, error) {
	ret := _m.Called(ctx, cmd)
