...
type MockMessagePublisher[T interface{}] struct {
	mock.Mock
}

// Publish provides a mock function with given fields: ctx, topicName, v
func (_m *MockMessagePublisher[T]) Publish(ctx context.Context, topicName string, v T) error {
...
func NewMockMessagePublisher[T interface{}](t interface {
	mock.TestingT
	Cleanup(func())
}) *MockMessagePublisher[T] {
	mock := &MockMessagePublisher[T]{}
	mock.Mock.Test(t)
